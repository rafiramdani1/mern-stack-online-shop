...
export const CANCELED = import.meta.env.VITE_STATUS_ORDER_CANCELLED
export const BEING_PACKED = import.meta.env.VITE_STATUS_ORDER_BEING_PACKED
export const BEING_SENT = import.meta.env.VITE_STATUS_ORDER_BEING_SENT
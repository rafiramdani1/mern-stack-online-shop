...
const EditProduct = () => {
  ...
  const { data: productById, isLoading, refetch: refetchProductById } = useGetProductByIdQuery(idProduct)
  // use get categories
      ...
      <div className="w-full bg-white rounded-lg shadow">
        <div className="p-6 space-y-4">
          ...
          <form onSubmit={handleEditProduct} className="space-y-4 md:space-y-6">
            ...
            <button type="submit"
              className="w-1/3 bg-cyan-500 text-white hover:bg-cyan-600 font-medium rounded-lg text-sm px-5 py-2.5 text-center"

                ...
                <div>
                  {isLogin ?
                    <ul className='flex text-textPrimary font-medium'>
                      <li>
                        <a onClick={Logout} className='cursor-pointer text-base hover:text-textHoverPrimary'>Keluar</a>
                      </li>
                    </ul>
                    :
                    <ul className='flex text-textPrimary font-medium'>
                      <li className='mr-3'>
                        <a href='/login' className='cursor-pointer text-base hover:text-textHoverPrimary'>Masuk</a>
                      </li>
                      <li className=''>
                        <a href='/register' className='cursor-pointer text-base hover:text-textHoverPrimary'>Daftar</a>
                      </li>
                    </ul>
                  }
